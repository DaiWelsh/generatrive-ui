...
export default function Dataset() {
  ...
  const submitNewAttribute = () => {
    console.log(`submit new attribute`, newName);
    datasetContext.addAttribute(newName);
    setNewName('');
    setAdding(false);
  };
  
  const cancelNewAttribute = () => {
    console.log(`cancel new attribute`, newName);
    setAdding(false);
  };
    ...
    <Fragment>
      ...
      {adding && 
        <form>
          ...
          <button onClick={submitNewAttribute}>Add</button>
